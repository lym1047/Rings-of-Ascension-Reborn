...
public class ItemRingEffect extends ItemRingBase {
    ...
    public ItemRingEffect(Properties properties, String tooltip, Supplier<Boolean> enabled, Holder<MobEffect> effect, Supplier<Integer> amplifier, GlintRenderTypes glintType) {
